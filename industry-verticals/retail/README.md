...
DwyerOmega is a demo website created to showcase a modern shopping experience. It highlights key features such as intuitive navigation, multilingual support, and engaging content presentation. The site is designed to demonstrate how a retail brand can deliver a seamless and personalized experience to its customers.
...
1. Use the existing dwyeromega search source
2. Create a new source in the CEC portal and link it to your application

### Use existing dwyeromega search source
