...
const IconDropdown = ({
  ...
  <Popover>
    <PopoverTrigger
      className="text-foreground-link hover:text-primary-dark data-[state=open]:text-primary transition-colors"
      aria-label={label}
    >
      {icon}
    </PopoverTrigger>
      ...
      <div className={`component navigation-icons ${props?.params?.styles?.trimEnd()}`} id={id}>
        <div className="flex items-center gap-3 p-4 lg:gap-5 [.component.header_&]:justify-end [.component.header_&]:px-0">
          <button
            ...
            className="hover:text-primary-dark text-foreground-link p-2 transition-colors"
          >
